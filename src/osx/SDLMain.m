...
{
	NSString *myBundle = [[NSBundle mainBundle] resourcePath];
//	NSString *fullpath = [NSString stringWithFormat:@"%@/Contents/Resources/%@",myBundle, fileName];
//	[[NSWorkspace sharedWorkspace] openFile:fullpath ];
	chdir ([myBundle cString]);   /* chdir to the binary app's parent */
...
- (void) applicationDidFinishLaunching: (NSNotification *) note
{
	...
	/* enable keypress events for the app, later filtered to just command+etc */
